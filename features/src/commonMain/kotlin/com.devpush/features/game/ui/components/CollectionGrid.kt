 ...
 * @param onCollectionEdit Callback when a collection edit is requested
 * @param onCollectionDelete Callback when a collection delete is requested
...
fun CollectionGrid(
    ...
    onCollectionEdit: (GameCollection) -> Unit,
    onCollectionDelete: (GameCollection) -> Unit,
